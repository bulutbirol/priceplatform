...
export default async function HomePage({ params }) {
  ...
  return <div className="catalog-home">
    <section className="catalog-intro shell">
      ...
      <div className="catalog-stats" aria-label={locale === "en" ? "Platform content" : "Platform içeriği"}><span><strong>9</strong> {copy.stats[0]}</span><span><strong>88</strong> {copy.stats[1]}</span><span><strong>1400+</strong> {copy.stats[2]}</span></div>
    </section>
